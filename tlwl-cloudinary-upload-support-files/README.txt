...
- CLOUDINARY_FOLDER, optional. Default: tlwl/story-submissions
- CLOUDINARY_MAX_FILE_SIZE, optional. Default: 104857600

Cloudinary test flow:
1. Trigger a fresh Netlify deploy after adding Cloudinary variables.
2. Open the story submission form.
3. Upload a small video, or paste a video link.
4. Optionally upload one photo or document.
5. Submit the story.
6. Check Supabase stories and media_assets for the Cloudinary URLs and metadata.
7. Open stories.html and the public story page to confirm the uploaded media displays.
