...
function renderMedia(story) {
  const thumb = story.video_thumbnail_url || story.thumbnail_url;
  if (thumb) {
    return `<div class="library-video-preview" style="background-image: url('${escapeHtml(thumb)}')"><span class="play-circle small">&#9658;</span></div>`;
  }
